...
namespace ufo {
    ...
    template <typename Sequence, typename Op, enable_if_t<!is_instantiation_of_v<SequenceOperator, Sequence> && is_instantiation_of_v<SequenceOperator, std::decay_t<Op>>> = enabler>
    ...
    template <typename LHSOp, typename RHSOp, enable_if_t<is_instantiation_of_v<SequenceOperator, std::decay_t<LHSOp>> && is_instantiation_of_v<SequenceOperator, std::decay_t<RHSOp>>> = enabler>
